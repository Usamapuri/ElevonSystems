...
/** Detail sheet for one customer: profile fields plus its full statement
 * with a running balance. Receiving a payment is added in Task D6. */
    ...
    <Sheet open={open} onOpenChange={(o) => !o && onOpenChange(false)}>
      <SheetContent size="lg">
        <SheetHeader>
          ...
          <SheetDescription>Profile and full ledger statement, oldest entry first.</SheetDescription>
        </SheetHeader>
